...
class Dummy {
    object testNotes {
        val notes = listOf<Note>(
            ...
            Note("1", "Kenyeret venni a tescoba", false, false, "2022-12-11", "2022-12-23"),
            Note("1", "Megvenni az új autót", false, false, "2022-12-11", "2022-12-23"),
            Note("1", "Elzárni a gázt a sütőben", true, false, "2022-12-11", "2022-12-23"),
            Note("1", "Új billentyűzetet venni", false, false, "2022-12-11", "2022-12-23"),
            Note("1", "Macska kaját venni", false, false, "2022-12-11", "2022-12-23"),
